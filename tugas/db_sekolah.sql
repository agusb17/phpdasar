...
(1,'qwer@gmail.com','jkgdfhjb','1234567'),
(2,'agus@gmail.com','agus','123');
...
CREATE TABLE `kelas` (
  ...
  `id_kelas` int(11) DEFAULT NULL,
  `id-walikelas` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `id-walikelas` (`id-walikelas`),
  KEY `id_kelas` (`id_kelas`),
  CONSTRAINT `kelas_ibfk_1` FOREIGN KEY (`id-walikelas`) REFERENCES `walikelas` (`id`),
  CONSTRAINT `kelas_ibfk_2` FOREIGN KEY (`id_kelas`) REFERENCES `kelas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `siswa` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nama_kelas` varchar(225) DEFAULT NULL,
